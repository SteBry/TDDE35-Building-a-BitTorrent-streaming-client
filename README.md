# TDDE35-Building-a-BitTorrent-streaming-client
Goal: Build and test the performance of a BitTorrent streaming client that 
implement a basic Zipf-based chunk exchange policy 
(e.g., “Peer-assisted On-demand Streaming of Stored Media using BitTorrent-like 
Protocols”, Carlsson and Eager, in Proc. of IFIP Networking 2007).

Most of the code is copied from the repository eliasson/pieces. All code 
written or changed by our team is clearly showed by comments.

Follow the instructions for pieces to use the client.
